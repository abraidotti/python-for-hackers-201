...
class BurpExtender(IBurpExtender, ITab):
    def registerExtenderCallbacks(self, callbacks):
        ...
        self.connect_button = swing.JButton(
            "[ --- Connect --- ]", actionPerformed=self.connect
        )
        self.send_button = swing.JButton(
            "[ --- Send Command --- ]", actionPerformed=self.send
        )
        self.disconnect_button = swing.JButton(
            "[ --- Disconnect --- ]", actionPerformed=self.disconnect
        )
